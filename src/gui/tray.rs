...
pub fn init_tray(settings: Arc<RwLock<Settings>>) -> Result<(TrayIcon, MenuId, MenuId), Box<dyn std::error::Error>> {
...
pub fn start_tray_handler(window_handle: WindowHandle<Root>, async_app: AsyncApp, settings: Arc<RwLock<Settings>>) {
